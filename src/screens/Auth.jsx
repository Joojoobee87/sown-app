          ...
          <form onSubmit={handleSignIn} className="flex flex-col gap-4">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-parchment text-subtle">or continue with</span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-black text-white rounded-xl px-4 py-3 text-sm font-medium hover:bg-gray-800 transition-colors"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.31.81-1.57.05-2.33-.96-2.33-2.37 0-1.41.76-2.18 2.33-2.23 1.31-.05 2.06.76 3.29.76 1.23 0 2.26-.71 3.29-1.76.83-.84 1.48-1.95 1.48-3.33 0-2.53-1.94-4.79-4.89-4.79-2.95 0-4.89 2.26-4.89 4.79 0 1.38.65 2.49 1.48 3.33 1.03 1.05 2.06 1.76 3.29 1.76 1.23 0 2.26-.71 3.29-1.76.83-.84 1.48-1.95 1.48-3.33 0-2.53-1.94-4.79-4.89-4.79-2.95 0-4.89 2.26-4.89 4.79z"/>
                </svg>
                Continue with Apple
              </button>
            </div>
